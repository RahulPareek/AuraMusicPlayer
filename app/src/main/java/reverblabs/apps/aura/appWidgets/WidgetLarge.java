...
public class WidgetLarge extends AppWidgetProvider {
    ...
    public static void checkEnabled(Context context, AppWidgetManager manager){
        widgetEnabled = manager.getAppWidgetIds(new ComponentName(context, WidgetLarge.class)).length != 0;
    }
...
//            Song nowPlaying;
//
//            nowPlaying = QueueManager.getCurrentSong();
//
//            widgetEnabled = true;
//
//            updateWidget(nowPlaying, context, appWidgetManager);
//        }
//
//          else {
...
//         }
    ...
    public static void updateWidget(Song song, Context context,
        ...
        if(widgetEnabled) {
            ...
            remoteViews.setViewVisibility(R.id.widget_large_song_name, View.VISIBLE);
            remoteViews.setViewVisibility(R.id.widget_large_artist_name, View.VISIBLE);
            remoteViews.setViewVisibility(R.id.widget_large_album_name, View.VISIBLE);

            remoteViews.setTextViewText(R.id.widget_large_song_name, song.getTitle());
            remoteViews.setTextViewText(R.id.widget_large_artist_name, song.getArtist());
            remoteViews.setTextViewText(R.id.widget_large_album_name, song.getAlbum());
//
//            if (metadataCompat != null) {
//                remoteViews.setImageViewBitmap(R.id.widget_large_album_art, metadataCompat.getBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART));
//            }
//            else {
//                remoteViews.setImageViewResource(R.id.widget_large_album_art, R.drawable.album_art);
//            }
...
//            }
            ...
            remoteViews.setOnClickPendingIntent(R.id.widget_large_album_art, pendingIntent);

            appWidgetManager.updateAppWidget(new ComponentName(context, WidgetLarge.class), remoteViews);
